...
```bash
make setup-dockerized PORT=5433
make docker-reset PORT=5433
```
...
```bash
make setup-dockerized-sudo PORT=5433
make docker-reset-sudo PORT=5433
```
...
- **Puerto 5432 ocupado**: levantar con `PORT=5433` (o cualquier puerto libre).
